                ...
                <table class="my-4 w-full divide-y divide-gray-300 text-center">
                    ...
                    <div class="">
                        ...
                        if($row->keterangan_izin == '-') {
                          echo '<a href="' . base_url('admin/ubah_absen_tahunan/') . $row->id . '">
                          ...
                          echo '<a href="' . base_url('admin/ubah_izin_tahunan/') . $row->id . '">
             <button class="text-blue-600">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
        </svg>
...
<script>
    ...
    timer: 1500
      ...
      setTimeout(() => {
        window.location.href= "<?php echo base_url('admin/hapus_tahunan/') ?>" + id;
      }, 1800);
    }
    })
  }
