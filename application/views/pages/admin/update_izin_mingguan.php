    ...
    <div class="md:flex min-h-screen">
        ...
        <main id="content" class="flex-1 p-6 lg:px-8 m-12">
            ...
            <?php foreach ($izin as $row):  $izin= $row->keterangan_izin;?>
                <form action="<?php echo base_url('karyawan/aksi_update_izin_mingguan') ?>" enctype="multipart/form-data"
                        method="post">
                        <input type="hidden" id="id" name="id" value="<?php echo $row->id ?>">
                    <div>
                        <label for="kegiatan" class="block text-gray-800 font-medium mb-2">Keterangan</label>
                        <textarea id="izin" name="izin" rows="6" class="bg-gray-50 w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500" required><?php echo $izin; ?></textarea>
                    </div>
