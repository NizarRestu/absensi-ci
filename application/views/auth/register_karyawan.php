            ...
            <div class="md:w-1/3 max-w-sm">
                ...
                <form action="<?php echo base_url('auth/aksi_register_karyawan') ?>" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <p class="text-sm text-rose-700 font-semibold">*Password minimal 8 karakter</p>
                    </div>
                    <div class="text-center md:text-left">
                    ...
                    <p class="text-sm mt-2">Sudah punya akun? <span>Silahkan <a class="text-rose-700 font-semibold" href="<?php echo base_url()?>">Login</a></span></p>
                </form>
            </div>
        </section>
    </div>
