                ...
                <form action="#" method="POST">
                    <div>
                        ...
                        <div class="relative mb-6">
                            <input type="text" class="w-full rounded-lg border p-4 pr-12 text-sm shadow-sm" placeholder="Masukan email" required>
                        </div>
                    </div>
                    <div>
                        <label for="password" class="sr-only">Password</label>
                        <div class="relative">
                            <input type="password" class="w-full rounded-lg border p-4 pr-12 text-sm shadow-sm" placeholder="Masukan password" required>
